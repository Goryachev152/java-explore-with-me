...
public class StatsController {
    ...
    public void addHit(@RequestBody ViewingRequestDto viewingRequestDto) {
        log.info("Received hit: {}", viewingRequestDto);
        statsService.addHit(viewingRequestDto);
    }

    @GetMapping("/stats")
    public List<ResultStatsDto> getStats(@RequestParam @DateTimeFormat(pattern = "yyyy-MM-dd HH:mm:ss") LocalDateTime start,
